...
const Footer: React.FC = () => {
  return (
    <footer className="bg-base text-foreground py-20 px-6 border-t border-foreground/5">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Link to="/" className="text-foreground/60 hover:text-accent transition-colors">Home</Link>
            <Link to="/projects" className="text-foreground/60 hover:text-accent transition-colors">Projects</Link>
            <Link to="/services" className="text-foreground/60 hover:text-accent transition-colors">Services</Link>
            <Link to="/contact" className="text-foreground/60 hover:text-accent transition-colors">Contact</Link>
          </div>
        </div>
      </div>
      
      <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-foreground/10 flex flex-col md:row justify-between items-center text-xs text-foreground/40">
