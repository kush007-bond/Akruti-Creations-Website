    ...
    <div className="pt-32 pb-20 bg-base">
      <header className="max-w-7xl mx-auto px-6 mb-40 text-center">
        ...
        >
          ...
          <p className="text-2xl text-foreground/50 max-w-3xl mx-auto font-medium leading-relaxed">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-px bg-foreground/5">
        {services.map((service, idx) => (
          ...
          >
            ...
            {/* Overlay Content */}
            <div className="absolute inset-0 bg-base/90 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-center p-12 md:p-20">
               <motion.div 
            ...
            {/* Default Label */}
            <div className="absolute bottom-10 left-10 text-foreground/30 font-black tracking-widest uppercase group-hover:opacity-0 transition-opacity">
              {service.title}
            </div>
          </motion.div>
        ))}
